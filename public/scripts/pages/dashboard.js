import { renderLayout } from "../layout.js?v=coffee-v149";
import { apiGet, canUsePermission, loadSession, loadState, scopedApiUrl } from "../store.js?v=coffee-v149";
...
const dashboard = apiGet(scopedApiUrl("/api/dashboard", state, session))?.data || null;
...
function drawSalesChart() {
  ...
  const days = (dashboard?.chart?.length ? dashboard.chart : Array.from({ length: 7 }, (_, index) => {
