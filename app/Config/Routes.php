...
$routes->group('api', ['namespace' => 'App\Controllers\Api'], static function ($routes) {
    $routes->post('auth/login', 'AuthController::login', ['filter' => 'rate-limit:10,60']);
    ...
    $routes->post('public/order', 'PublicOrderController::submit', ['filter' => 'rate-limit:20,60']);
    ...
    $routes->post('public/forgot-password', '\App\Controllers\LoginController::publicForgotPassword', ['filter' => 'rate-limit:5,60']);
    ...
    $routes->post('ai/tool-execute', 'AiBridgeController::executeTool');
});
$routes->group('api/page', static function ($routes) {
    $routes->get('login/bootstrap', 'LoginController::bootstrap');
    $routes->post('login/submit', 'LoginController::submit', ['filter' => 'rate-limit:10,60']);
    $routes->post('login/logout', 'LoginController::logout');
    $routes->post('login/face-verify', 'LoginController::faceVerify', ['filter' => 'rate-limit:15,60']);
    $routes->post('login/face-identify', 'LoginController::faceIdentify', ['filter' => 'rate-limit:15,60']);
    $routes->post('login/fingerprint-verify', 'LoginController::fingerprintVerify', ['filter' => 'rate-limit:15,60']);
    $routes->post('login/fingerprint-identify', 'LoginController::fingerprintIdentify', ['filter' => 'rate-limit:15,60']);
    $routes->post('ai/analyze', '\App\Controllers\Api\AiBusinessController::analyze');
    $routes->post('ai/chat', '\App\Controllers\Api\AiBusinessController::chat');
    $routes->get('ai/quota', '\App\Controllers\Api\AiBusinessController::quota');
    ...
    $routes->post('order/submit', 'OnlineOrderController::submit', ['filter' => 'rate-limit:20,60']);
});
...
$routes->group('api', ['namespace' => 'App\Controllers\Api', 'filter' => 'jwt-auth'], static function ($routes) {
    ...
    $routes->post('page/ai/analyze', 'AiBusinessController::analyze');
    $routes->post('page/ai/chat', 'AiBusinessController::chat');
    $routes->get('page/ai/quota', 'AiBusinessController::quota');
    $routes->get('page/ai/providers', 'AiBusinessController::providers');
    $routes->get('page/ai/data-logs', 'AiBusinessController::dataLogs');
...
$routes->get('(:segment)/pages/ai-analyst.html', 'AppPageController::tenantPage/$1/ai-analyst.html');
$routes->get('pages/pos.html', 'PosController::show');
$routes->get('pages/profile.html', 'AppPageController::page/profile.html');
$routes->get('pages/ai-analyst.html', 'AppPageController::page/ai-analyst.html');
